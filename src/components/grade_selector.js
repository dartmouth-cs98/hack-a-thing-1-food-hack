  ...
  return (
    <div>
      ...
      <div className="grade-btn-container">
        <GradeRangeItem gradeRange="K-2" image="/assets/balloon_k-2.png" />
        <GradeRangeItem gradeRange="3-5" image="/assets/balloon_3-5.png" />
        <GradeRangeItem gradeRange="6-8" image="/assets/balloon_6-8.png" />
      </div>
    </div>
  );
};
